...
'''
To Build the Mandelbrot set:
We from 'C' based on the values fo the 'screen_array' array index
excecute 'Z (n + 1) = Z (n) ^ 2 + C' a specified number of times (max_iter) or
until |Z| < 2 in this case count the number of iterations
find pixel color based on num_iter / max_iter
'''
